...
//		});
        ...
        textField_14.addFocusListener(new FocusAdapter() {
            @Override
            public void focusGained(FocusEvent e) {
                JTextField[] fields = {textField_6, textField_28, txtAnGiang};
                ArrayList<String> string_list = new ArrayList<String>();
                for (JTextField jTextField : fields) {
                    if (!jTextField.getText().isEmpty()) {
                        string_list.add(jTextField.getText());
                ...
                try {
                    ...
                    if (parts.length >= 7) {
                        ...
                        if (address_parts.length == 3) {
                            ...
                            txtAnGiang.setText(address_parts[2]);
                        } else if (address_parts.length == 4) {
                            textField_6.setText(address_parts[0]);
                            textField_28.setText(address_parts[1]);
                            txtAnGiang.setText(address_parts[3]);
                        } else if (address_parts.length == 5) {
                            textField_6.setText(address_parts[1]);
                            textField_28.setText(address_parts[2]);
                            txtAnGiang.setText(address_parts[4]);
                        }
